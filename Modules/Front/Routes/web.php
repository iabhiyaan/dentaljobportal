...
Route::group([
    ...
    Route::group(['middleware' => ['checkauth:employer', 'role:employer'],], function () {
        Route::get('employer-profile/{employerId}', [EmployerController::class, 'getEmployerProfile'])->name('getProfile');
        Route::put('employer-profile/{employerId}', [EmployerController::class, 'updateEmployerProfile'])->name('updateProfile');
        Route::get('company-profile/{employerId}', [EmployerController::class, 'getCompanyProfile'])->name('getCompanyProfile');
        Route::get('employer-overview/{employerId}', [EmployerController::class, 'getEmployerOverview'])->name('getEmployerOverview');
