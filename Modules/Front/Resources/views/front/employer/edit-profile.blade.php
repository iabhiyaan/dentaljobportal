                                    ...
                                    <div class="basic-info-box px-3 mt-3">
                                        <ul class="row">
                                            ...
                                            <li class="col-12"> <span class="basic-info-title">Company Name</span>:<span
                                                    class="basic-info-detial">{{ $detail->employer_name }}</span></li>
                                            ...
                                            <li class="col-12"> <span
                                                    class="basic-info-title poppin-bold">Summary</span>:<span></span>
                                        ...
                                        <form action="{{ route('employer.updateProfile', $detail->id) }}" class="row"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" type="text" name="address"
                                                    value="{{ $detail->address }}" placeholder="Enter Organization address">
                                            </div>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="file" name="profile_image" value="{{ $detail->profile_image }}"
                                    ...
                                    <div class="basic-info-form mt-3 px-3">
                                        <form action="{{ route('employer.updateProfile', $detail->id) }}" class="row"
                                            ...
                                            <div class="form-group col-sm-12 col-md-6">
                                                ...
                                                <input class="form-control" type="text" value="{{ $detail->employer_name }}"
                                            ...
                                            <div class="form-group col-sm-12 col-md-6">
                                                ...
                                                <input class="form-control" type="text"
                                                    value="{{ $detail->employer_designation }}" name="employer_designation"
