            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <div class="post-job-btn-box py-2">
                        ...
                        <button class="btn bg-green"><a href="post-job.html">Post a Job</a></button>
                        <p>this section will be shown when the user register for the first time and have not posted any job yet.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-box  text-blue">
                            <div class="row py-2">
                                <div class="col-9">
                                    <h6><i class="fa fa-briefcase" aria-hidden="true"></i>Recieved Application</h6>
                                </div>
