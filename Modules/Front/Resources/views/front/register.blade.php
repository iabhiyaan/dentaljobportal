                                ...
                                <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class=" row justify-content-center mt-3">
                                                ...
                                                <div class="from-group col-sm-12 mt-3">
                                                    <input type="password" class="form-control"
                                                        placeholder="*Remember Password" name="confirm_password" />
                                                ...
                                                <div class="from-group col-sm-12 mt-3">
                                                    <div class="terms-condition">
                                                        ...
                                                        <label for="remember-password">Yes, I agree to the processing of my
                                                            personal data in line with the school's Privacy Policy</label>
                                                    </div>
                                                </div>
                                                <div class="from-group col-sm-12 mt-3">
                                    ...
                                    <div class="tab-pane fade" id="employer" role="tabpanel" aria-labelledby="employer-tab">
                                        <div class=" row justify-content-center mt-3">
                                            ...
                                            <div class="from-group col-sm-12 mt-3">
                                                <input type="password" class="form-control" placeholder="*Remember Password"
                                                    required />
                                            </div>
                                            <div class="from-group col-sm-12 mt-3">
                                                <div class="terms-condition">
                                            ...
                                            <div class="from-group col-sm-12 mt-3">
                                                <button class="d-btn  bg-green " type="submit"> <a
