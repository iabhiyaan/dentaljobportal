...
<head>
    ...
    {{--
    <link href="{{ asset('/assets/admin/css/main.min-1.css') }}" rel="stylesheet" /> --}}
    <!-- PAGE LEVEL STYLES-->
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <img src="/images/main/{{ $dashboard_composer->logo_left }}" />
                            @endisset --}}
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    {{-- jobcategory --}}
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('jobcategory', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                                <span class="nav-label">jobcategory</span>
                                <i class="fa fa-angle-left arrow"></i>
                            </a>
                            <ul class="nav-2-level collapse">
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('jobcategory.create') }}">
                                        <span class="fa fa-plus"></span>
                                        Add new
                                    </a>
                                </li>
                    ...
                    {{-- job --}}
                    {{-- @if ($role == 'super-admin' || ($role == 'admin' && in_array('job', $user_access)))
                        --}}
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                    ...
                    {{-- page --}}
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('page', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                    ...
                    {{-- Employer/JobSeeker --}}
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('roleuser', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                                <span class="nav-label">Employer/JobSeeker</span>
                                <i class="fa fa-angle-left arrow"></i>
                            </a>
                            <ul class="nav-2-level collapse">
                                <li>
                    ...
                    {{-- Employer --}}
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('employementsalarytype', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                                <span class="nav-label">employement salary type</span>
                                <i class="fa fa-angle-left arrow"></i>
                            </a>
                            <ul class="nav-2-level collapse">
                                <li>
                                    <a href="{{ route('employmentsalarytype.index') }}">
                                        <span class="fa fa-plus"></span>
                                        All lists
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('employmentsalarytype.create') }}">
                                        <span class="fa fa-plus"></span>
                                        Add New
                                    </a>
                                </li>
                    ...
                    {{-- Employer --}}
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('employer', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                    ...
                    {{-- setting --}}
                    <li>
                        <a href="{{ route('setting.index') }}"><i class="sidebar-item-icon fa fa-cog"></i>
