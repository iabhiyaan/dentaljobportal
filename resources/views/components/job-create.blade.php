                     ...
                     <div class="form-group col-md-6">
                        <label>Published Date</label>
                            <input class="form-control" name="published_date" type="date"
                             value="{{  $pubDate ?? old('published_date') }}" 
                             placeholder="Enter Published Date" >
                     </div>
                     <div class="form-group col-md-6">
                        <label>Deadline Date:</label>
                            <input class="form-control" name="deadline_date" type="date"
                             value="{{  $deadDate ?? old('deadline_date') }}" 
                 ...
                 <div class="row">
                     ...
                     <div class="form-group col-md-6">
                         ...
                         <select name="country" id="country" class="form-control">
                             ...
                             <option value="England" {{ ($detail!=null && $detail->country)==="England" ?? old('country') }}>England</option>
                             <option value="Scotland" {{ ($detail!=null && $detail->country)==="Scotland" ?? old('country') }}>Scotland</option>
                             <option value="Wales" {{ ($detail!=null && $detail->country)==="Wales" ?? old('country') }}>Wales</option>
                             <option value="Nothern Ireland" {{ ($detail!=null && $detail->country)==="Nothern Ireland" ?? old('country') }}>Nothern Ireland</option>
